...
public class CommentController {
    ...
    // Authentication authentication // Usuario autenticado
        ...
        // User username = (User) authentication.getPrincipal(); //Debería obtener el
        // usuario autenticado
    ...
    // Authentication authentication
        ...
        return success ? ResponseEntity.ok().build() : ResponseEntity.status(403).body("No tienes permisos");
    }
